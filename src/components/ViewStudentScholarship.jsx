...
class ViewStudentScholarship extends Component {
    ...
    constructor(props)
    {
        ...
        this.state={
            ...
            studentUserId:this.props.match.params.userId,
            scholarshipList:[]
    ...
    componentDidMount()
    {
        ScholarshipService.viewScholarshipStatusUpdate(this.state.studentUserId).then(res=>
            {
    ...
    back()                                                                                  
    {
        this.props.history.push(`/StudentHomePage/${this.state.studentUserId}`);
    }
